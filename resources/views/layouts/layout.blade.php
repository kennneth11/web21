...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>laravel 8 - Balendres,jk</title>
        <!-- Fonts -->
  ...
  if( !regex.test(key) ) {
    ...
    <body>
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('files.index') }}" class="list-group-item list-group-item-action bg-light">Activity 2 - Uploading</a>
            <a href="#" class="list-group-item list-group-item-action bg-light">Activawdawdawdwa</a>
